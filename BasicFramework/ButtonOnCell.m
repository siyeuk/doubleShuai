...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.tableView registerClass:[ButtonOnTBVC class] forCellReuseIdentifier:@"cellId"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ButtonOnTBVC *cell = [tableView dequeueReusableCellWithIdentifier:@"cellId" forIndexPath:indexPath];
    cell.superVC = self;
    return cell;
}
